...
layout:     post
title:      "前端开发常用网站与资源收藏"
description: "围绕「前端开发常用网站与资源收藏」整理核心知识点、实践经验、常见问题和参考资料，便于持续查阅。"
date:       2018-01-11 17:05:00
author:     "Qz"
...
Playground：https://www.mermaidchart.com/play#pako:eNqtjkEOgjAQRa_y07jQZEiKEVEXHkKX1EWBUSFYCBQCMd5doMQT2MWbP_Onv32LpExZnEQ_JE9dWy9mq5XBeGxmC4YSV11wgwt3bFpWwpm9p_usQZRrQ7hzTHjpmqCrelIDIW_NhGKctQ9CwxWhTCzBlB0h5eTmggYXpMTyANaZwWqjBHZSSnjeGb4_Krcd6xpRMLaE_cwwmHjYTjzO2peu-NJ1zpp5mJ3wd335QpEZ_meq-HwByfdVyg
...
[https://csscoco.com/inspiration/#/](https://csscoco.com/inspiration/#/)
...
[Add the Browserslist config to display compatible browsers](https://browsersl.ist/)
...
[https://wangchujiang.com/tools/#/](https://wangchujiang.com/tools/#/)
...
- 搜索 npm 包，比 npmjs.com 体验更现代。
- 查看包信息：版本、依赖、下载量、README、源码、类型、模块格式等。
- 比较多个包，例如 `tsup` vs `tsdown` vs `unbuild`。
- 看包体积、依赖风险、过期依赖、安全相关信息。
- URL 兼容 npmjs.com，很多 npm 包页面可以把域名换成 `npmx.dev` 或 `xnpmjs.com` 查看。

### eruda

Console for mobile browsers

移动端 console 工具  （用于代替vconsole）
...
[https://contrib.rocks/preview?repo=angular%2Fangular-ja](https://contrib.rocks/preview?repo=angular%2Fangular-ja)

### 展示 github star history
