---
layout:     post
title:      "Web 渲染与可视化实践总结"
description: "围绕「Web 渲染与可视化实践总结」整理核心知识点、实践经验、常见问题和参考资料，便于持续查阅。"
...
图形渲染基础：[Canvas 相关（2D 绘图 API、离屏 Canvas 等）]({% post_url 2017-09-25-canvas相关-myblog %})
