...
description: "围绕「AST 抽象语法树与前端工程实践」整理核心知识点、实践经验、常见问题和参考资料，便于持续查阅。"
...
[ast原理](https://zhaomenghuan.js.org/blog/js-ast-principle-reveals.html)

词法分析和语法分析不是完全独立的，而是交错进行的，也就是说，词法分析器不会在读取所有的词法记号后再使用语法分析器来处理。在通常情况下，每取得一个词法记号，就将其送入语法分析器进行分析。

![](https://zhaomenghuan.js.org/assets/img/js-token-ast.f635f3cf.png)
